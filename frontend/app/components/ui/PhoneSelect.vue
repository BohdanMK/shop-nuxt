<template>
        <USelect
            ...
            :ui="{
              ...
              placeholder: '',
              arrow: 'hidden',
              content: 'w-[220px] bg-[rgba(0,0,0,0.8)] text-white border-y-0 border-x border-x-[#ff0000] ring-0 outline-none shadow-none',
              viewport: 'divide-y-0',
              group: 'divide-y-0',
              separator: 'hidden',
              item: 'text-white font-semibold data-[active=true]:bg-white/10 data-[highlighted=true]:bg-white/10 cursor-pointer py-[3px] px-2',
